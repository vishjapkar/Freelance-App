		...
		<div class="row">
			...
			<div class="collapse navbar-collapse" id="navbarNavDropdown">
				<ul class="navbar-nav" style="font-size: 16px;">
					...
					<li class="nav-item">
						<a class="nav-link ml-3" href="get_job.php">Get Job</a>
					</li>
					<li class="nav-item">
						<a class="nav-link ml-3" href="mybids.php">My Bids</a>
					</li>
					<li class="nav-item">
						<a class="nav-link ml-3" href="my-bids-demo.php">Work in Progress</a>
					</li>
					<li class="nav-item">
